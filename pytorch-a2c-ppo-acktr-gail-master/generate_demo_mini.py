        ...
        while termination is False:
            ...
            for actor_snapshot in world_snapshot:
                ...
                if 'vehicle.audi.tt' in actual_actor.type_id:
                    ...
                    tmp_obs[7] = 1.0 - float(abs(actor_snapshot.get_transform().location.x - destination_location.x) + abs(actor_snapshot.get_transform().location.y - destination_location.y)) / float(
                        abs(world.location_mycar.x - destination_location.x) + abs(world.location_mycar.y - destination_location.y))
