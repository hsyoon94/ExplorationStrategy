        ...
        while termination is False:
            ...
            for actor_snapshot in world_snapshot:
                ...
                if 'vehicle.audi.tt' in actual_actor.type_id:
                    ...
                    tmp_obs[1] = lng
                    tmp_obs[2] = ori
                    tmp_obs[3] = math.sqrt(math.pow(actor_snapshot.get_velocity().x, 2) + math.pow(actor_snapshot.get_velocity().y, 2)) / 10
            ...
            for actor_snapshot in world_snapshot:
                ...
                if 'vehicle.tesla.model3' in actual_actor.type_id:
                    if math.sqrt(math.pow(actor_snapshot.get_transform().location.x, 2) + math.pow(actor_snapshot.get_transform().location.y, 2)) <= 25.0:
                        tmp_obs[4] = othercar_rad_grid(actor_snapshot.get_transform().location.x - actor_snapshot_mycar.get_transform().location.x, actor_snapshot.get_transform().location.y - actor_snapshot_mycar.get_transform().location.y)  # grid location
                    else:
                        tmp_obs[4] = 2.0
