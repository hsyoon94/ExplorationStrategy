...
class PPO():
    def __init__(self,
        ...
        # self.optimizer = optim.SGD(actor_critic.parameters(), lr=lr, momentum=0.9)
    ...
    def update(self, rollouts):
        ...
        for e in range(self.ppo_epoch):
            ...
            for sample in data_generator:
                ...
                action_diff = action_log_probs - old_action_log_probs_batch

                for components in action_diff:
                    components[0] = min(components[0], 20)
